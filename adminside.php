        ...
        <div class="main">
            ...
            <div class="cardBox">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<div class='cardName'>".$row['PetrolName']." : </div>";
                    echo "<div class='cardNumber'>".$row['TotalLitres']." Litres</div>";
                ...
                ?>
                        ...
                        <div class="SeeD">
                            <button><a href="petrol.php"></a>See Details</button>
                        </div>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<div class='cardName'>".$row['PetrolName']." : </div>";
                    echo "<div class='cardNumber'>".$row['AvailableLitres']." Litres</div>";
                ...
                ?>
                        ...
                        <div class="SeeD">
                            <button><a href="petrol.php">See Details</a></button>
                        </div>
